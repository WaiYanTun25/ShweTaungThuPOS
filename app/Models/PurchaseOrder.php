...
class PurchaseOrder extends Model
{
    ...
    protected $fillable = ['voucher_no', 'branch_id', 'supplier_id', 'total_quantity', 'amount', 'total_amount', 'tax_percentage', 'tax_amount', 'discount_percentage', 'discount_amount', 'amount_type', 'remark', 'order_date', 'is_lock'];
